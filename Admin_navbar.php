...
<body>
			...
			<div class="log-nav">
				...
				<ul class="ul3">
				   <div class="userSearch">
					...
					<form class="search-form" action="Searching.php" method="post">
					<div class="userSearchBox1">
					
			        <input class="search-text" type="text" name="keyword" placeholder="Enter users information to search">
    ...
    <script>
        ...
        let userSearchBox = document.querySelector('.userSearchBox1');
